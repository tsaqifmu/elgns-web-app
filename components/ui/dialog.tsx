...
const DialogHeader = ({
  ...
  <div
    className={cn(
      "flex flex-col space-y-1.5 rounded-t-lg px-5 py-3 text-center sm:text-left",
      className,
    )}
    {...props}
  />
...
const DialogFooter = ({
  ...
  <div
    className={cn(
      "flex flex-col-reverse bg-gray-100 p-[0.625rem] sm:flex-row sm:justify-end sm:space-x-2",
      className,
    )}
    {...props}
  />
